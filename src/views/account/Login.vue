  ...
  <div class="container">
    <div class="form">
      <form @submit.prevent="handleSubmit" id="sign-in-form">
        ...
        <button type="submit" form="sign-in-form" id="btn">Sign In</button>
        <h5>
          Don't have an account?
          <router-link to="/account/sign-up">Join now</router-link>
        </h5>
        <h5>
          <router-link to="/account/forgot-password/step1"
    ...
    async handleSubmit() {
      try {
        ...
        if (res.data) {
          ...
          this.submitPasswordToken(res.data)
...
#icon-div a img:hover,
#icon-div a img:active {
  transform: scale(1.3);
}
